...
if __name__ == "__main__":
    env = DummyVecEnv([lambda: gym.make("PikachuVolleyballPixel-v0", render_mode="rgb_array", is_player1_computer=False, is_player2_computer=True, limited_timestep=1000)])
